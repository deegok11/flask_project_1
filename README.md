...
- 🎯 Entry points to execute your program using `python -m <flask_project_1>` or `$ flask_project_1` with basic CLI argument parsing.
...
---
# flask_project_1 Flask Application

Awesome flask_project_1 created by deegok11
...
```bash
git clone https://github.com/deegok11/flask_project_1 flask_project_1
cd flask_project_1
make install
```
...
```bash
flask_project_1 create-db   # run once
flask_project_1 populate-db  # run once (optional)
flask_project_1 add-user -u admin -p 1234  # ads a user
flask_project_1 run
```
